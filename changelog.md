...
- Fixed a crash when leaving a world on NeoForge.
...
- Increased Harvesting Time now defaults to disabled.
- Updated Spanish, French, Brazilian Portuguese, and Ukrainian translations.

### Fixed

- Vein-mined item drops now spawn together at the block the player broke.
